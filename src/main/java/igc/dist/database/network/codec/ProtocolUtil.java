...
final class ProtocolUtil {
    ...
    public static final int MESSAGE_ID_HEADER_SIZE = 2;
    private static final int MAX_MESSAGE_LENGTH = 16777215;
    private static final int MESSAGE_LENGTH_HEADER_SIZE = 3;
    public static final int HEADER_SIZE = MESSAGE_ID_HEADER_SIZE + MESSAGE_LENGTH_HEADER_SIZE;

    public static int decodeMessageId(final byte[] in) {
    ...
    public static int decodePayloadLength(final byte[] in) {
    ...
    public static byte[] messageToBytes(final int messageId, final byte[] message) {
