package igc.dist.database.network.codec;

import static igc.dist.database.network.codec.ProtocolDecoder.ProcessingState.MESSAGE_HEADER;
import static igc.dist.database.network.codec.ProtocolDecoder.ProcessingState.PAYLOAD;
import static igc.dist.database.network.codec.ProtocolUtil.HEADER_SIZE;
import static igc.dist.database.network.codec.ProtocolUtil.MESSAGE_ID_HEADER_SIZE;
import static igc.dist.database.network.codec.ProtocolUtil.decodeMessageId;
import static igc.dist.database.network.codec.ProtocolUtil.decodePayloadLength;
